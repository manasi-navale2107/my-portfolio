...
const PROJECTS = [
  {
  id: "smilesync-ai-dental-system",
  title: "SmileSync – AI Dental Appointment System",
  description: "An AI-powered dental care platform that helps users diagnose dental problems and book dentist appointments using an intelligent chatbot integrated with OpenAI API.",
  tags: ["Next.js", "Node.js", "Express.js", "OpenAI API", "Tailwind CSS"],
  githubUrl: "https://github.com/manasi-navale2107/smilesync-ai",
  icon: Zap,
  accentColor: "hsl(210 80% 60%)",
  code: `Hi`,
},
  {
  id: "gaplens-ai-interview-platform",
  title: "GapLens-AI – AI Interview Preparation Platform",
  description: "An AI-based interview preparation platform that analyzes candidate profiles and generates personalized technical interview questions using Google Generative AI.",
  tags: ["React", "Node.js", "Express.js", "MongoDB", "Google Generative AI"],
  githubUrl: "https://github.com/manasi-navale2107/gaplens-ai",
  icon: Zap,
        ...
        <div className="relative max-w-3xl mx-auto text-center flex flex-col items-center gap-6">
          ...
          <AnimatedSection delay={100}>
            <h1 className="text-5xl md:text-7xl font-bold tracking-tight leading-none">
              <span className="text-foreground">Manasi</span>{" "}
              <span className="gradient-text">Navale</span>
            </h1>
          </AnimatedSection>
  ...
  View Resume
          ...
          <AnimatedSection delay={500}>
            <div className="flex items-center gap-4">
              ...
              <a
                href="https://www.linkedin.com/in/manasinavale07/"
                target="_blank"
                rel="noopener noreferrer"
                className="text-muted-foreground hover:text-foreground transition-colors"
              ...
              <a
                href="https://mail.google.com/mail/?view=cm&fs=1&to=navalemanasi@gmail.com"
                target="_blank"
                rel="noopener noreferrer"
              >
            ...
            <AnimatedSection delay={100}>
              <div className="space-y-5">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  I am a Full-Stack Developer and AI enthusiast with experience in building scalable web applications and AI-powered solutions. I work with modern technologies like React, Node.js, and machine learning tools to develop efficient, user-focused systems. I focus on writing clean, maintainable code and continuously improving my skills to build impactful real-world applications.
                </p>
                <p className="text-muted-foreground leading-relaxed">
              ...
              <div className="relative">
                <div className="rounded-lg border border-border bg-card p-5 font-mono text-sm">
                  ...
                  <div className="space-y-1 text-[0.78rem] leading-relaxed">
                    ...
                    <div className="pl-4"><span className="text-foreground">name:</span> <span className="syntax-string">'Manasi Navale'</span>,</div>
      ...
      <footer className="border-t border-border py-8 px-6">
        <div className="max-w-5xl mx-auto flex flex-wrap items-center justify-between gap-4">
          ...
          <span className="text-xs text-muted-foreground">
            &copy; 2026 Manasi Navale. All rights reserved.
          </span>
        </div>
      </footer>
    </div>
